...
public class HtmlCleaner {
	...
	public static String stripElement(String html, String name) {
		...
		String regex = String.join("", "(?i)<", name, "[ >][\\s\\S]*?</" + name + " *>");
		return html.replaceAll(regex, "");
	}
	...
	/**
	 * Removes the declaration at the top of an html file
	 * @param html original html file
	 * @return html text without the declaration
	 */
	public static String removeDeclaration(String html) {
		String regex = "(?i)<!DOCTYPE [^>]*>";
		return html.replaceAll(regex, "");
	}

	/**
	 * Removes all HTML tags, declarations, and entities
	 *
	...
	public static String stripHtml(String html) {
		html = removeDeclaration(html);
		// removed stripBlockElements(html) because it suits the overall program flow
		html = stripTags(html);
